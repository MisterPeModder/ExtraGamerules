...
import com.misterpemodder.customgamerules.GameRuleRegistry;
...
public class ExtraGameRules implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        registerIntRule("lightningProbability", DefaultValues.LIGHTNING_PROBABILITY,
                ExtraGameRuleValues::setLightningProbability,
                ExtraGameRuleValues::getLightningProbability);
        ...
        GameRuleRegistry.INSTANCE.registerGameRule("extra-gamerules", "pvp",
                new ExtendedGameRule<Boolean>("boolean", GameRules.Type.BOOLEAN,
                        DefaultValues.PVP_ENABLED, Boolean::valueOf,
                        ExtraGameRuleValues::setPvpEnabled, ExtraGameRuleValues::isPvpEnabled) {
                    @Override
        ...
        registerBooleanRule("fallDamage", DefaultValues.FALL_DAMAGE,
                ExtraGameRuleValues::setFallDamageEnabled,
                ExtraGameRuleValues::isFallDamageEnabled);
        registerBooleanRule("fireDamage", DefaultValues.FIRE_DAMAGE,
                ExtraGameRuleValues::setFireDamageEnabled,
                ExtraGameRuleValues::isFireDamageEnabled);
        registerBooleanRule("doSnowMelt", DefaultValues.SNOW_MELTS,
                ExtraGameRuleValues::setSnowMelt, ExtraGameRuleValues::doSnowMelt);
        ...
        registerBooleanRule("doHunger", DefaultValues.DO_HUNGER,
                ExtraGameRuleValues::setHungerEnabled, ExtraGameRuleValues::isHungerEnabled);
    ...
    private static ExtendedGameRule<Integer> registerIntRule(String name, Integer defaultValue,
        ...
        return register("integer", name, GameRules.Type.INTEGER, defaultValue, Integer::valueOf,
                updateValueFunction, getValueFunction)
                        .validator(ExtendedGameRule::validatePositive);
    }
